...
pub struct Rated {
    ...
    /// information. It ignores the off-diagonal terms, so it is a lower bound
    /// on the true uncertainty — good enough to tell 1700 ± 15 from 1700 ± 200,
    /// which is the distinction the page needs to draw.
    pub stderr: f64,
    pub games: f64,
