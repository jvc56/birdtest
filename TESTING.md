...
`birdtest-contribute` reports `0.4.0`, the shipped `MIN_MAGPIE_VERSION` default,
and a checkout from before the audits' fixes reports `0.3.0` or lower and is refused. The
